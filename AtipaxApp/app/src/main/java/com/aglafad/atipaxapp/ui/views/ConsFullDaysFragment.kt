...
class ConsFullDaysFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cons_full_days, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ConsFullDaysFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ConsFullDaysFragment().apply {
